...
from tests.initPagesWithDriver import init
...
class TestFirstTest:
    ...
    def test_FirstTest(self):
        self.initial.goTo.bp.moveToSite("https://www.ebay.com/")
        self.initial.goTo.lp.writeInSearchInput('watch')
        self.initial.goTo.lp.clickOnSearchBtn()
        allPrices = self.initial.goTo.pp.findAllPrices()
        print('the min price is '+ str(allPrices[0]) + ', the max price is '+str (allPrices[-1]))
